...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = NSURL(string:"https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyD87Y272FU1aozRZtjfZRZ0dwX3oYDoB6M")!
        ...
        let task = session.dataTaskWithURL(url) { (data, response, error) in
            if error != nil {
                ...
                do{
                    ...
                    print("error throw while converting json data.")
                }
            }
        }
        task.resume()
